...
- **Too many warnings:** Report this to the user, and proceed to delivery.
- **Acceptable intersections:** Proceed to delivery.

**What counts as "too many":** More than a few unavoidable ⚠️ warnings (e.g., purely decorative overlap) is acceptable.
